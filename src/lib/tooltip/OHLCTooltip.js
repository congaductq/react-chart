	...
	return (
		...
		>
			...
			>
				...
				{
					isDefined(close) && displayTexts.c ? (
				...
				{
					isDefined(volume) && displayTexts.v ? (
				...
				{
					isDefined(max_cap) && displayTexts.m ? (
